...
<html lang="en">
    ...
    <body>
            ...
            <div class="whitebg">
                <div id="Lcontent7" class="content">
                    <?PHP
                        if($_SESSION['SorD'] == "Student") // waneeer een student is ingelogd is de Nieuw labjournaal knop en de bekijk knop beschikbaar.
                        {
                            echo '<a class="bluebtn Lbutton"  href="labjournaalNieuw.php?NEW">'.$LabjournaalNieuw.'</a>
                                <a class="bluebtn Lbutton" id="PbuttonLeft" href="labjournalenBekijken.php?jaar=0">'.$Bekijklabjournalen.'</a>';
                        }
                    ?> 
                    ...
                    <?PHP
                            ...
                            {
                                echo "<table class='LTable'><tr> <th>".$Titel."</th><th>".$Auteur."</th><th>".$LabjournaalDatum."</th><th>".$Vakken."</th><th>".$Jaar."</th>";
                                ...
                                while(mysqli_stmt_fetch($stmt)) // alle resultaten in een rij van de tabel zetten.
                                {
                                    ...
                                    if($_SESSION["SorD"] == "Student") // de bewerk en de verwijder-knop van de student printen.
                                    {
                                        ...
                                        echo'<td> <a class="labjournaalLink" onclick="DeleteLabjournaal('.$labjournaalID .');"> <i class="fa fa-trash "></i> </a> </td>';
        ...
        <script>
            function DeleteLabjournaal(ID) {
                var r = confirm("Weet je het zeker?");
                if (r == true) {
                    window.location.href = "../Include/deleteLabjournaal.inc.php?ID="+ID;
                }
            }
        </script>
