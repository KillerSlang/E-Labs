...
<html lang="en">
    <head>
        ...
        <?php
            if($_COOKIE['taal'] == 'english') { // taal van de titel nederlands of engels.
                echo "<title>View Preperations</title>";
            }
            else{
                echo "<title>Voorbereidingen Bekijken</title>";
            }
        ?>
        <?php                                   // docent en student hebben een andere achtergrond.
    ...
    <?php 
        ...
        ?>
        <main id="Protocol" <?=$backgrounddocent?>>
        <div class="PageTitle">
                <h1><?= $TeBekijkenVoorbereidingen ?></h1>
                <hr>
            </div>
            <div class="whitebg">
                <div id="Lcontent6" class="content">
                    <a class="bluebtn Lbutton" id="lbuttonLeft" href='voorbereidingen.php?jaar=0'><?= $TeBewerkenVoorbereidingen?></a>
                    ...
                    <?php
                        ...
                        queryaanmaken('SELECT uitvoerders,voorbereidingID
                                    FROM voorbereiding');// haal de uitvoerders array en voorbereidingID op uit de database.
                        ...
                        {            
                            ...
                            while (mysqli_stmt_fetch($stmt)) 
                            {
                                ...
                                foreach($voorbereidingArray as $input)
                                {
                                    ...
                                    {
                                        array_push($voorbereidingArray,$voorbereidingID);  // zet het ID van voorbereiding in de nieuwe array.
                                    }
                                }
                            }
                            $queryError = false; // er is geen error dus de queryerror is false.
                            
                        }else {$queryError = true;  }// wanneer er geen voorbereidingen op te halen zijn is de true.
                            ...
                            queryAanmakenAdvanced( // laat voorbereidingen zien op volgorde van de datum
                                'ORDER BY voorbereidingDatum DESC ',
                                false); 
                            if(!isset($_GET['page']) || $_GET['page'] == 0){ // maximaal 20 voorbereidingen
                            ...
                            {
                                echo "<table class='LTable'><tr><th>".$Titel."</th><th>".$Auteur."</th><th>".$Voorbereidingdatumtekst."</th><th>".$Vakken."</th><th>".$Jaar."</th><th>".$Bekijken."</th></tr>";
                                while(mysqli_stmt_fetch($stmt))
                                {
                                    echo '<tr>
                                    ...
                                    echo'<td><a class="labjournaalLink" href="voorbereidingbekijken.php?ID='.$voorbereidingID .'">'.$Bekijken.' </a> </td>
                                    </tr>' ;
                                }
                                echo"</table>";
                                $queryError = false;
                            ...
                            if($queryError) // error code
                            { 
                                echo '<div class="bericht">
                                        <b>'.$GeenVoorbereidingenOmTeBekijken.'.</b><hr>
                                    </div>';
                            }
