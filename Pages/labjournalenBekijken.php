...
<html lang="en">
    <head>
        ...
        if($_COOKIE['taal'] == 'english') {
            echo "<title>View Lab journals</title>";
        }
        else{
    ...
    <?php 
        ...
        <div class="PageTitle">
                <h1><?=$TeBekijkenLabjournalen?></h1>
                <hr>
            </div>
            <div class="whitebg">
                <div id="Lcontent6" class="content">
                    <a class="bluebtn Lbutton" id="lbuttonLeft" href='labjournalen.php?jaar=0'><?=$Bewerklabjournalen?></a>
                    ...
                    <?php
                        ...
                        {            
                            ...
                            {
                                echo "<table class='LTable'><tr><th>".$Titel."</th><th>".$Auteur."</th><th>".$LabjournaalDatum."</th><th>".$Vakken."</th><th>".$Jaar."</th><th>".$Bekijken."</th></tr>";
                                while(mysqli_stmt_fetch($stmt))
                                {
                                    echo '<tr>
                                    ...
                                    echo'<td><a class="labjournaalLink" href="labjournaalBekijken.php?ID='.$labjournaalID .'">'.$Bekijken.' </a> </td>
                                    </tr>' ;
                                }
                                echo"</table>";
                                $queryError = false;
                            ...
                            { 
                                echo '<div class="bericht">
                                        <b>'.$GeenLabjournalenOmTeBekijken.'</b><hr>
                                    </div>';
                            }
