...
<html lang="en">
    ...
    echo '<form class="Lform" action="../Include/addlabjournaal.inc.php" method="post" enctype="multipart/form-data">
                ...
                <label>'.$LabjournaalVeiligheid.': </label><p>'.$LabjournaalEA.'</p>
                ...
                <label>'.$LabjournaalWaarneming.': </label><p>'.$LabjournaalA.'</p>
                ...
                <label>'.$LabjournaalMeetR.': </label><p>'.$LabjournaalEA.'</p>
                ...
                <label>'.$LabjournaalLogboekU.': </label><p>'.$LabjournaalEW.'</p>
                ...
                <label>'.$LabjournaalObservatieU.': </label><p>'.$LabjournaalAW.'</p>
                ...
                <label>'.$LabjournaalWeegU.': </label><p>'.$LabjournaalE.'</p>
                <input type="file" id="uploadweeggegevens" name="uploadweeggegevens" accept=".xls,.xlsx">

                <br>
                <br>

                <label>'.$LabjournaalImg.': </label><p>'.$LabjournaalA.'</p>
