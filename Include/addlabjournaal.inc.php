...
{    
    ...
    if(!empty($_FILES["uploadveiligheid"])) // waneer er een bestand upgeload is bij uploadveiligheid
    {
        ...
        $target_dir = "../upload/labjournaal/veiligheden/Veiligheid"; // sla het bestand op in de map uploads
    ...
    {
        // upload waarnemingen
        $fileType = pathinfo(basename($_FILES["uploadwaarnemingen"]["name"]), PATHINFO_EXTENSION);  
        $target_dir = "../upload/labjournaal/waarnemingen/Waarneming ";
        $date = date("Y-m-d_G-i-s");
        $target_file_waarnemingen = $target_dir.$_SESSION["Name"]." ".$date.'.'.$fileType;
    ...
    if(!empty($_FILES["uploadmeetresultaten"]))
    {
        ...
        $fileType = pathinfo(basename($_FILES["uploadmeetresultaten"]["name"]), PATHINFO_EXTENSION);    
        $target_dir = "../upload/labjournaal/meetresultaten/Meetresultaat ";
        $date = date("Y-m-d_G-i-s");
        $target_file_meetresultaten = $target_dir.$_SESSION["Name"]." ".$date.'.'.$fileType;
    ...
    {
        // upload logboek
        $fileType = pathinfo(basename($_FILES["uploadlogboek"]["name"]), PATHINFO_EXTENSION);    
        $target_dir = "../upload/labjournaal/logboeken/Logboek ";
        $date = date("Y-m-d_G-i-s");
        $target_file_logboek = $target_dir.$_SESSION["Name"]." ".$date.'.'.$fileType;
    ...
    {
        // upload observatie
        $fileType = pathinfo(basename($_FILES["uploadobservaties"]["name"]), PATHINFO_EXTENSION);         
        $target_dir = "../upload/labjournaal/observaties/Observatie ";
        $date = date("Y-m-d_G-i-s");
        $target_file_observaties = $target_dir.$_SESSION["Name"]." ".$date.'.'.$fileType;
    ...
    {
        // upload weeggegevens
        $fileType = pathinfo(basename($_FILES["uploadweeggegevens"]["name"]), PATHINFO_EXTENSION); 
        $target_dir = "../upload/labjournaal/weeggegevens/Weeggegevens ";
        $date = date("Y-m-d_G-i-s");
        $target_file_weeggegevens = $target_dir.$_SESSION["Name"]." ".$date.'.'.$fileType;
    ...
    {
        // upload afbeeldingen
        $fileType = pathinfo(basename($_FILES["uploadafbeelding"]["name"]), PATHINFO_EXTENSION); 
        $target_dir = "../upload/labjournaal/afbeeldingen/Afbeelding ";
        $date = date("Y-m-d_G-i-s");
        $target_file_afbeeldingen = $target_dir.$_SESSION["Name"]." ".$date.'.'.$fileType;
        // Controleer of het bestand al bestaat
