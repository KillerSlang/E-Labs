...
{    
    if(!empty($_FILES["uploadveiligheid"]))
    {
        ...
        $target_dir = "../upload/labjournaal/veiligheden/Veiligheid ";
    ...
    if(!empty($_FILES["uploadwaarnemingen"]))
    {
        ...
        $target_dir = "../upload/labjournaal/waarnemingen/Waarnemingen ";
        $date = date("Y-m-d_G-i-s");
    ...
    if(!empty($_FILES["uploadmeetresultaten"]))
    {
        ...
        $target_dir = "../upload/labjournaal/meetresultaten/Meetresultaten ";
        $date = date("Y-m-d_G-i-s");
