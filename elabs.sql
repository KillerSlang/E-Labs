...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 10 dec 2020 om 12:52
...
INSERT INTO `labjournaal` (`labjournaalID`, `studentID`, `docentID`, `labjournaalTitel`, `experimentDatum`, `experimentBeginDatum`, `experimentEindDatum`, `logboek`, `observaties`, `weeggegevens`, `afbeelding`, `figuur`, `afbeeldingBron`, `bijlageLogboek`, `bijlageObservaties`, `bijlageWeeggegevens`) VALUES
...
INSERT INTO `student` (`studentID`, `studentNummer`, `studentNaam`, `studentEmail`, `wachtwoord`) VALUES
...
--
ALTER TABLE `labjournaal`
  MODIFY `labjournaalID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
